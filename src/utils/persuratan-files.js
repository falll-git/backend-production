...
function persistFile({
  ...
  if (!entitySegments) {
    throw new Error("Kategori penyimpanan persuratan tidak valid.");
  }
  ...
  if (!targetDirectory) {
    throw new Error("Lokasi penyimpanan persuratan tidak valid.");
  }
  ...
  if (!absolutePath) {
    throw new Error("Nama file persuratan tidak valid.");
  }
